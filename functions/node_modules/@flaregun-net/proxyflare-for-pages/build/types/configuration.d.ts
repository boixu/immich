...
export declare type Methods = "GET" | "HEAD" | "POST" | "PUT" | "DELETE" | "CONNECT" | "OPTIONS" | "TRACE" | "PATCH";
export declare type Configuration = {
    global?: {
         ...
         *
         * `x-proxyflare-matched-pathname: string` is the matched from.pattern pathname
         *
         * `x-proxyflare-proxied-pathname: string` is the pathname of the proxied request
         *
         * @defaultValue `false`
         */
        debug?: boolean;
...
declare type ToR2Bucket = ToBase & {
    /**
